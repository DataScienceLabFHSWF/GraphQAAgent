...
_SYSTEM_PROMPT = """\
You are a question analysis expert for a nuclear decommissioning knowledge graph.
Given a user question, produce a JSON object with EXACTLY these fields:
{
  ...
  "detected_types": list of ontology class names (e.g. "NuclearFacility", "DecommissioningMethod"),
...
class QuestionParser:
    ...
    def __init__(self, ollama: LangChainOllamaProvider) -> None:
        self._ollama = ollama
